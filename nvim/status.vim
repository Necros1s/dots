function! RedrawModeColors(mode) " {{{
  " Normal mode
  if a:mode == 'n'
    hi MyStatuslineAccent guifg=#000000 gui=none guibg=#FFFFFF ctermfg=234 ctermbg=none
    hi MyStatuslineFilename guifg=#000000 gui=none guibg=#FFFFFF ctermfg=141 ctermbg=234
    hi MyStatuslineAccentBody guibg=#292b34 gui=none guifg=#7ed491 ctermfg=044 ctermbg=234
  " Insert mode
  elseif a:mode == 'i'
    hi MyStatuslineAccent guifg=#292b34 gui=none guibg=none
    hi MyStatuslineFilename guifg=#c0c0c0 gui=none guibg=#585e74
    hi MyStatuslineAccentBody guibg=#292b34 gui=none guifg=#f9929b ctermfg=044 ctermbg=234
...
hi MyStatuslineSeparator guifg=#585e74 gui=none guibg=none ctermfg=234 ctermbg=none

hi MyStatuslineModified  guifg=#585e74 gui=none guibg=none
hi MyStatuslineFiletype guibg=NONE gui=NONE guifg=#585e74 ctermfg=234 ctermbg=none
hi MyStatuslineFiletypeBody guifg=#ccaced gui=bold guibg=#585e74 ctermfg=141 ctermbg=234
...
hi MyStatuslineLineCol guifg=#585e74 gui=NONE guibg=NONE ctermfg=234 ctermbg=none
hi MyStatuslineLineColBody guibg=#585e74 gui=none guifg=#c0c0c0 ctermfg=141 ctermbg=234
